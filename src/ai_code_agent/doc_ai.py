...
class LocalLLMClient:
    ...
    def generate_docstring(self, func_name: str, source: str, language: str = "en") -> str:
        # Improved Prompt: Forces the AI to be brief.
        prompt = (
            f"You are a strict code documentation tool. "
            f"Write a single Python docstring line for the function '{func_name}'. "
            f"Do not include quotes. Do not say 'Here is the docstring'. "
